...
function replaceCheckboxes2() {
	for (var q = 0; q < checkboxes.length; q++) {
		checkboxArea = $('myCheckbox' +q);
		//asign actions
		checkboxArea.onclick = new Function('rechangeCheckboxes('+q+')');
		if(!isMac.test(navigator.vendor)) {
...
function replaceSelects() {
    for(var q = 0; q < selects.length; q++) {
		...
		if(selects[q].options.length > 10) {
			optionsDiv.style.height = '10em';
...
function hideOptions(e) { //hiding the options on mouseout
	...
	if (reltg) {
		if(((reltg.nodeName != 'A') && (reltg.nodeName != 'DIV') && (reltg.nodeName != 'xul:slider') && (reltg.nodeName != 'xul:thumb') && (reltg.nodeName != 'xul:scrollbarbutton')) || ((reltg.nodeName == 'A') && (reltg.className=="selectButton") && (reltg.nodeName != 'DIV') && (reltg.nodeName != 'xul:slider') && (reltg.nodeName != 'xul:thumb') && (reltg.nodeName != 'xul:scrollbarbutton'))) {
